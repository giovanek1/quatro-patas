...
describe('AdoptService', () => {
  ...
  it('should return the correct adoption modals', () => {
    const expectedModals: AdoptionModal[] = [
      {
    ...
    expect(service.adoptionModals).toEqual(expectedModals);
  });

  it('should return the correct adoption cards', () => {
    const expectedCards: AdoptionCard[] = [
      {
    ...
    expect(service.adoptionCards).toEqual(expectedCards);
  });

  it('should set the adoption cards correctly', () => {
    const newCards: AdoptionCard[] = [
      {
        srcImg: './../../../assets/img/new-dog.jpeg',
        title: 'New Dog',
        description: 'Novo amigo, macho',
        isFav: false,
        adopted: false,
      },
    ];

    service.adoptionCards = newCards;

    expect(service.adoptionCards).toEqual(newCards);
  });
});
